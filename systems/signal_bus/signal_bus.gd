## Stateless event transport system for.
##
## SignalBus provides edge-triggered event communication between systems.[br]
...
## Component value changed on an entity.
## [br][br]
...
## Entity was spawned in the world.
## [br][br]
...
## World state value changed (global facts).
## [br][br]
